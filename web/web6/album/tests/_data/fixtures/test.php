...
// Проверка на наличие параметра командной строки
if ($argc < 2) {
    echo "Ошибка: не указано имя пользователя.\n";
    exit(1);
}

$user_rname = $argv[1];  // получаем имя пользователя из параметров командной строки
...
echo "Имя пользователя: " . $user_lname . "\n";
